                ...
                <div class="row">
                    <div class="3u">
                        ...
                        <section>
                            ...
                            <h2>${artigos[0].titulo}(${artigos[0].assunto})</h2>
                            <p>
                                ${artigos[0].texto}                                
                            </p>
                        </section>
                    ...
                    <div class="3u">
                        ...
                        <section>
                            ...
                            <h2>${artigos[1].titulo}(${artigos[1].assunto})</h2>
                            <p>
                                ${artigos[1].texto}
                            </p>
                        </section>
                    ...
                    <div class="3u">
                        ...
                        <section>
                            ...
                            <h2>${artigos[2].titulo}(${artigos[2].assunto})</h2>
                            <p>
                                ${artigos[2].texto}
                            </p>
                        </section>
                    ...
                    <div class="3u">
                        ...
                        <section>
                            ...
                            <h2>${artigos[3].titulo}(${artigos[3].assunto})</h2>
                            <p>
                                ${artigos[3].texto}
                            </p>
                        </section>
                ...
                <div class="row">
                    ...
                    <div class="4u">
                        ...
                        <section>
                            ...
                            <ul class="check-list">
                                <li>Engenheiro de sistemas <a href="http://www.gumga.com.br">(Gumga)</a></li>
                                <li>Aulas na gradução e pós-graduação</li>
                                <li>Software web, mobile e embarcado</li>
                                <li>Pesquisa</li>
                                <li>Consultoria</li>
                            </ul>
                        </section>
